...
/* Set the number of local threads on runtime. */
void BlasSetNumThreadsLocal(int numThreadsLocal);

/* Get the number of threads on runtime. */
int BlasGetNumThreads(void);

/* Get the number of local threads on runtime. */
int BlasGetNumThreadsLocal(void);
...
/*  KML_BLAS is compiled using KUPL threading model */
#define BLAS_KUPL 3
...
typedef struct {
    ...
    char componentAbiVersion[VERSION_STRUCT_LEN];
...
void cblas_chomatmul(const enum CBLAS_ORDER ordering, const enum CBLAS_TRANSPOSE transa,
    const enum CBLAS_TRANSPOSE transb, const BLASINT m, const BLASINT n, const __fp16 *alpha, __fp16 *a,
    const BLASINT lda, __fp16 *b, const BLASINT ldb, __fp16 *c, const BLASINT ldc);
...
void cblas_hgemm(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE transA, const enum CBLAS_TRANSPOSE transB,
    const BLASINT M, const BLASINT N, const BLASINT K, const __fp16 alpha, const __fp16 *A, const BLASINT lda,
    const __fp16 *B, const BLASINT ldb, const __fp16 beta, __fp16 *C, const BLASINT ldc);
void cblas_shgemm(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE transA, const enum CBLAS_TRANSPOSE transB,
...
void cblas_chgemm(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE transA, const enum CBLAS_TRANSPOSE transB,
    const BLASINT M, const BLASINT N, const BLASINT K, const void *alpha, const void *A, const BLASINT lda,
    const void *B, const BLASINT ldb, const void *beta, void *C, const BLASINT ldc);
void cblas_cshgemm(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE transA, const enum CBLAS_TRANSPOSE transB,
    const BLASINT M, const BLASINT N, const BLASINT K, const void *alpha, const void *A, const BLASINT lda,
    const void *B, const BLASINT ldb, const void *beta, void *C, const BLASINT ldc);
...
void cblas_bgemm(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE transA, const enum CBLAS_TRANSPOSE transB,
    const BLASINT M, const BLASINT N, const BLASINT K, const __bf16 alpha, const __bf16 *A, const BLASINT lda,
    const __bf16 *B, const BLASINT ldb, const __bf16 beta, __bf16 *C, const BLASINT ldc);
void cblas_sbgemm(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE transA, const enum CBLAS_TRANSPOSE transB,
    const BLASINT M, const BLASINT N, const BLASINT K, const float alpha, const __bf16 *A, const BLASINT lda,
    const __bf16 *B, const BLASINT ldb, const float beta, float *C, const BLASINT ldc);
void cblas_cbgemm(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE transA, const enum CBLAS_TRANSPOSE transB,
    const BLASINT M, const BLASINT N, const BLASINT K, const void *alpha, const void *A, const BLASINT lda,
    const void *B, const BLASINT ldb, const void *beta, void *C, const BLASINT ldc);
void cblas_csbgemm(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE transA, const enum CBLAS_TRANSPOSE transB,
    const BLASINT M, const BLASINT N, const BLASINT K, const void *alpha, const void *A, const BLASINT lda,
    const void *B, const BLASINT ldb, const void *beta, void *C, const BLASINT ldc);
...
size_t cblas_sgemm_pack_get_size(const enum CBLAS_IDENTIFIER identifier, const BLASINT m, const BLASINT n,
                                 const BLASINT k);
size_t cblas_dgemm_pack_get_size(const enum CBLAS_IDENTIFIER identifier, const BLASINT m, const BLASINT n,
                                 const BLASINT k);
size_t cblas_cgemm_pack_get_size(const enum CBLAS_IDENTIFIER identifier, const BLASINT m, const BLASINT n,
                                 const BLASINT k);
size_t cblas_zgemm_pack_get_size(const enum CBLAS_IDENTIFIER identifier, const BLASINT m, const BLASINT n,
                                 const BLASINT k);

size_t cblas_bgemm_pack_get_size(const enum CBLAS_IDENTIFIER identifier, const BLASINT m, const BLASINT n,
                                 const BLASINT k);

void cblas_sgemm_pack(const enum CBLAS_ORDER order, const enum CBLAS_IDENTIFIER identifier,
                      const enum CBLAS_TRANSPOSE trans, const BLASINT m, const BLASINT n, const BLASINT k,
                      const float *src, const BLASINT ld, float *dst);
void cblas_dgemm_pack(const enum CBLAS_ORDER order, const enum CBLAS_IDENTIFIER identifier,
                      const enum CBLAS_TRANSPOSE trans, const BLASINT m, const BLASINT n, const BLASINT k,
                      const double *src, const BLASINT ld, double *dst);
void cblas_cgemm_pack(const enum CBLAS_ORDER order, const enum CBLAS_IDENTIFIER identifier,
                      const enum CBLAS_TRANSPOSE trans, const BLASINT m, const BLASINT n, const BLASINT k,
                      const void *src, const BLASINT ld, void *dst);
void cblas_zgemm_pack(const enum CBLAS_ORDER order, const enum CBLAS_IDENTIFIER identifier,
                      const enum CBLAS_TRANSPOSE trans, const BLASINT m, const BLASINT n, const BLASINT k,
                      const void *src, const BLASINT ld, void *dst);
void cblas_bgemm_pack(const enum CBLAS_ORDER order, const enum CBLAS_IDENTIFIER identifier,
                      const enum CBLAS_TRANSPOSE trans, const BLASINT m, const BLASINT n, const BLASINT k,
                      const __bf16 *src, const BLASINT ld, __bf16 *dst);

void cblas_sgemm_compute(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE transA,
                         const enum CBLAS_TRANSPOSE transB, const BLASINT m, const BLASINT n, const BLASINT k,
                         const float alpha, const float *a, const BLASINT lda, const float *b, const BLASINT ldb,
                         const float beta, float *c, const BLASINT ldc);
void cblas_dgemm_compute(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE transA,
                         const enum CBLAS_TRANSPOSE transB, const BLASINT m, const BLASINT n, const BLASINT k,
                         const double alpha, const double *a, const BLASINT lda, const double *b, const BLASINT ldb,
                         const double beta, double *c, const BLASINT ldc);
void cblas_cgemm_compute(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE TransA,
                         const enum CBLAS_TRANSPOSE TransB, const BLASINT m, const BLASINT n, const BLASINT k,
                         const void *alpha, const void *a, const BLASINT lda, const void *b, const BLASINT ldb,
                         const void *beta, void *c, const BLASINT ldc);
void cblas_zgemm_compute(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE TransA,
                         const enum CBLAS_TRANSPOSE TransB, const BLASINT m, const BLASINT n, const BLASINT k,
                         const void *alpha, const void *a, const BLASINT lda, const void *b, const BLASINT ldb,
                         const void *beta, void *c, const BLASINT ldc);
                         
void cblas_bgemm_compute(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE transA,
                         const enum CBLAS_TRANSPOSE transB, const BLASINT m, const BLASINT n, const BLASINT k,
                         const __bf16 alpha, const __bf16 *a, const BLASINT lda, const __bf16 *b, const BLASINT ldb,
                         const __bf16 beta, __bf16 *c, const BLASINT ldc);
